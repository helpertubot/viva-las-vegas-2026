              ...
              <div class="bracket-card-top">
                ...
                ${b.submitted
                  ...
                  : `<span class="bracket-card-badge draft">Draft</span>
                     <button class="bracket-card-delete" onclick="event.stopPropagation(); deleteBracket(${b.id})" title="Delete draft">
      ...
      <div class="bracket-editor-header">
        ...
        <div class="bracket-editor-actions">
          ${locked
            ...
            : (config.bracket_lock_timestamp && Date.now() / 1000 >= config.bracket_lock_timestamp)
              ? `<span class="locked-badge" style="font-size:13px;">\uD83D\uDD12 Brackets Locked</span>`
...
function confirmSubmit() {
  ...
  const lockTs = config.bracket_lock_timestamp || 0;
  if (lockTs && Date.now() / 1000 >= lockTs) {
    showToast('Brackets are locked — the tournament has started', 'error');
    return;
  }
...
async function takeBet(betId) {
  ...
  if (!confirm(`Are you sure you want to take ${desc}? This cannot be undone.`)) return;
  try {
